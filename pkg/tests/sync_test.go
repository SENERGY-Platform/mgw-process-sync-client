...
func startTestDeploymentWithBusinessKey(conf configuration.Config, mqtt paho.Client, id string, businessKey string) func(t *testing.T) {
	return func(t *testing.T) {
...
func createTestDeploymentWithRestart(conf configuration.Config, mqtt paho.Client, name string, bpmn string, svg string) func(t *testing.T) {
	return func(t *testing.T) {
		msg, err := json.Marshal(deploymentmodel.Deployment{
			Id:   "test-deployment-id_" + name,
			Name: name,
